...
import { Plus, Trash2, Save, Edit2, X, Check, ChevronDown, ChevronUp, ShieldOff } from 'lucide-react';
    ...
    <div className="card" style={{ padding: '1.5rem', minHeight: '80vh', overflowY: 'auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1rem' }}>
        ...
        <section style={{ marginTop: '1rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer', marginBottom: '1rem', borderBottom: '1px solid var(--color-border)', paddingBottom: '0.5rem' }} onClick={() => setDisplayExpanded(!displayExpanded)}>
          ...
          {displayExpanded && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '400px' }}>
              ...
              <button className="btn btn-primary" style={{ alignSelf: 'flex-start', marginTop: '1rem' }}>
                <Save size={18} style={{ marginRight: '0.5rem' }} /> Lưu Cài đặt
              </button>
            </div>
          )}
        </section>
